...
| `/claim snapshot remove <snapshotId> [claimId]` | Delete a snapshot by ID. |

Snapshots use structure NBT (Paper/Spigot 1.20+). Claims larger than 128 blocks on any axis cannot be snapshotted.
