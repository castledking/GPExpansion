...
When [CrowBar](https://github.com/castledking/CrowBar), a Fabric client mod, is installed alongside GPExpansion, claim waypoints display the **claim name** and a **bowtie marker** on the locator bar to claim owner and trusted players. CrowBar reads the same locator data GPExpansion sends and renders readable name tags above each waypoint.
